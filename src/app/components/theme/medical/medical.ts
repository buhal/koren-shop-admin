...
export class Medical {
  ...
  home_page$: Observable<IMedical> = inject(Store).select(ThemeState.homePage);
  ...
  ngOnInit() {
    ...
    const home_page$ = this.store.dispatch(new GetHomePageAction({ slug: 'medical' }));
          ...
          column_banner_product: {
            ...
            offer_banner_1: {
              ...
              redirect_link: {
                ...
                link_type:
                  homePage?.content?.column_banner_product?.offer_banner_1?.redirect_link
                    ?.link_type,
                product_ids:
                  homePage?.content?.column_banner_product?.offer_banner_1?.redirect_link
                    ?.product_ids,
            ...
            offer_banner_2: {
              ...
              redirect_link: {
                ...
                link_type:
                  homePage?.content?.column_banner_product?.offer_banner_2?.redirect_link
                    ?.link_type,
                product_ids:
                  homePage?.content?.column_banner_product?.offer_banner_2?.redirect_link
                    ?.product_ids,
  ...
  // Merge Products Ids
  concatDynamicProductKeys(obj: IMedical): number[] {
    const result: number[] = [];

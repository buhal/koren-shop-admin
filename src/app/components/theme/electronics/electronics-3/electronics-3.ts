...
import { IBanners, IElectronicThree } from '../../../../shared/interface/theme.interface';
...
@Component({
  ...
  templateUrl: './electronics-3.html',
  styleUrl: './electronics-3.scss',
})
export class Electronics3 {
  private store = inject(Store);
  formBuilder = inject(FormBuilder);
  private renderer = inject(Renderer2);
  private document = inject<Document>(DOCUMENT);

  home_page$: Observable<IElectronicThree> = inject(Store).select(ThemeState.homePage);
  ...
  public page_data: IElectronicThree;
  public active = 'home_banner';
  public form: FormGroup;
  public banner = 1;
  public offerBanner2 = 1;
  public productListTab = 1;
  ...
  constructor() {
    ...
    this.form = new FormGroup({
      content: new FormGroup({
        ...
        category_product_1: new FormGroup({
          status: new FormControl(true),
        ...
        category_product_2: new FormGroup({
          title: new FormControl(''),
          category_ids: new FormControl([]),
          status: new FormControl(true),
        }),
      ...
      slug: new FormControl('electronics_three'),
    });
  }
  ...
  ngOnInit() {
    ...
    const home_page$ = this.store.dispatch(new GetHomePageAction({ slug: 'electronics_three' }));
  ...
  patchForm() {
    this.home_page$.subscribe(homePage => {
      ...
      this.selectedCategories =
        homePage?.content?.category_product_1?.categories?.category_ids || [];
      this.selectedProductCategory = homePage?.content?.category_product_2?.category_ids || [];
      ...
      this.form.patchValue({
        content: {
          ...
          banner: {
            main_banner: {
              status: homePage?.content?.banner?.main_banner?.status,
              image_url: homePage?.content?.banner?.main_banner?.image_url,
              redirect_link: {
                link: homePage?.content?.banner?.main_banner?.redirect_link?.link,
                link_type: homePage?.content?.banner?.main_banner?.redirect_link?.link_type,
                product_ids: homePage?.content?.banner?.main_banner?.redirect_link?.product_ids,
              },
            },
            grid_banner_1: {
              status: homePage?.content?.banner?.grid_banner_1?.status,
              image_url: homePage?.content?.banner?.grid_banner_1?.image_url,
              redirect_link: {
                link: homePage?.content?.banner?.grid_banner_1?.redirect_link?.link,
                link_type: homePage?.content?.banner?.grid_banner_1?.redirect_link?.link_type,
                product_ids: homePage?.content?.banner?.grid_banner_1?.redirect_link?.product_ids,
              },
            },
            grid_banner_2: {
              status: homePage?.content?.banner?.grid_banner_2?.status,
              image_url: homePage?.content?.banner?.grid_banner_2?.image_url,
              redirect_link: {
                link: homePage?.content?.banner?.grid_banner_2?.redirect_link?.link,
                link_type: homePage?.content?.banner?.grid_banner_2?.redirect_link?.link_type,
                product_ids: homePage?.content?.banner?.grid_banner_2?.redirect_link?.product_ids,
              },
            },
            grid_banner_3: {
              status: homePage?.content?.banner?.grid_banner_3?.status,
              image_url: homePage?.content?.banner?.grid_banner_3?.image_url,
              redirect_link: {
                link: homePage?.content?.banner?.grid_banner_3?.redirect_link?.link,
                link_type: homePage?.content?.banner?.grid_banner_3?.redirect_link?.link_type,
                product_ids: homePage?.content?.banner?.grid_banner_3?.redirect_link?.product_ids,
              },
            },
          },
          category_product_1: {
            status: homePage?.content?.category_product_1?.status,
            categories: {
              category_ids: homePage?.content?.category_product_1?.categories?.category_ids,
              status: homePage?.content?.category_product_1?.categories?.status,
            },
            products: {
              product_ids: homePage?.content?.category_product_1?.products?.product_ids,
              status: homePage?.content?.category_product_1?.products?.status,
            },
          },
          category_product_2: {
            title: homePage?.content?.category_product_2?.title,
            category_ids: homePage?.content?.category_product_2?.category_ids,
            status: homePage?.content?.category_product_2?.status,
          },
          offer_banner_1: {
  ...
  // Merge Products Ids
  concatDynamicProductKeys(obj: IElectronicThree): number[] {
    const result: number[] = [];

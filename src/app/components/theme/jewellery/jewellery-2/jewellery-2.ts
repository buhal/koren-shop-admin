...
export class Jewellery2 {
  ...
  home_page$: Observable<IJewelryTwo> = inject(Store).select(ThemeState.homePage);
  ...
  ngOnInit() {
    const home_page$ = this.store.dispatch(new GetHomePageAction({ slug: 'jewellery_two' }));
  ...
  patchForm() {
    this.home_page$.subscribe(homePage => {
          ...
          product_banner: {
            ...
            center_panel: {
              banner_1: {
                ...
                redirect_link: {
                  link: homePage?.content?.product_banner?.center_panel.banner_1?.redirect_link
                    ?.link,
                  link_type:
                    homePage?.content?.product_banner?.center_panel.banner_1?.redirect_link
                      ?.link_type,
                  product_ids:
                    homePage?.content?.product_banner?.center_panel.banner_1?.redirect_link
                      ?.product_ids,
              ...
              banner_2: {
                ...
                redirect_link: {
                  link: homePage?.content?.product_banner?.center_panel.banner_2?.redirect_link
                    ?.link,
                  link_type:
                    homePage?.content?.product_banner?.center_panel.banner_2?.redirect_link
                      ?.link_type,
                  product_ids:
                    homePage?.content?.product_banner?.center_panel.banner_2?.redirect_link
                      ?.product_ids,
      ...
      homePage?.content?.offer_banner_1?.banners?.forEach((banner: IBanners) =>
  ...
  // Merge Products Ids
  concatDynamicProductKeys(obj: IJewelryTwo): number[] {
    const result: number[] = [];

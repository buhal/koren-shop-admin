...
import { IBanners, IVideoSlider } from '../../../shared/interface/theme.interface';
...
export class VideoSlider {
  ...
  home_page$: Observable<IVideoSlider> = inject(Store).select(ThemeState.homePage);
  ...
  constructor() {
    ...
    this.form = new FormGroup({
      ...
      slug: new FormControl('video_slider'),
    });
  }

  ngOnInit() {
    const blogs$ = this.store.dispatch(new GetBlogsAction({ status: 1 }));
    const home_page$ = this.store.dispatch(new GetHomePageAction({ slug: 'video_slider' }));
    ...
    this.home_page$.subscribe(homePage => {
      ...
      this.form.patchValue({
        content: {
          ...
          collection_banner: {
            banner_1: {
              image_url: homePage?.content?.collection_banner?.banner_1?.image_url,
              status: homePage?.content?.collection_banner?.banner_1?.status,
              tag: homePage?.content?.collection_banner?.banner_1?.tag,
              title: homePage?.content?.collection_banner?.banner_1?.title,
              redirect_link: {
                link: homePage?.content?.collection_banner?.banner_1?.redirect_link?.link,
                link_type: homePage?.content?.collection_banner?.banner_1?.redirect_link?.link_type,
                product_ids:
                  homePage?.content?.collection_banner?.banner_1?.redirect_link?.product_ids,
              },
            },
            banner_2: {
              image_url: homePage?.content?.collection_banner?.banner_2?.image_url,
              status: homePage?.content?.collection_banner?.banner_2?.status,
              tag: homePage?.content?.collection_banner?.banner_2?.tag,
              title: homePage?.content?.collection_banner?.banner_2?.title,
              redirect_link: {
                link: homePage?.content?.collection_banner?.banner_2?.redirect_link?.link,
                link_type: homePage?.content?.collection_banner?.banner_2?.redirect_link?.link_type,
                product_ids:
                  homePage?.content?.collection_banner?.banner_2?.redirect_link?.product_ids,
              },
            },
            banner_3: {
              image_url: homePage?.content?.collection_banner?.banner_3?.image_url,
              status: homePage?.content?.collection_banner?.banner_3?.status,
              tag: homePage?.content?.collection_banner?.banner_3?.tag,
              title: homePage?.content?.collection_banner?.banner_3?.title,
              redirect_link: {
                link: homePage?.content?.collection_banner?.banner_3?.redirect_link?.link,
                link_type: homePage?.content?.collection_banner?.banner_3?.redirect_link?.link_type,
                product_ids:
                  homePage?.content?.collection_banner?.banner_3?.redirect_link?.product_ids,
              },
            },
          },
          category_product: {
          ...
          parallax_banner: {
            ...
            sub_title: homePage?.content?.parallax_banner?.sub_title,
  ...
  // Merge Products Ids
  concatDynamicProductKeys(obj: IVideoSlider): number[] {
    const result: number[] = [];

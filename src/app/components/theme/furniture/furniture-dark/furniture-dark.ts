...
export class FurnitureDark {
  ...
  home_page$: Observable<IFurnitureDark> = inject(Store).select(ThemeState.homePage);
  ...
  public page_data: IFurnitureDark;
  ...
  ngOnInit() {
    ...
    const home_page$ = this.store.dispatch(new GetHomePageAction({ slug: 'furniture_dark' }));
          ...
          product_list_2: {
            ...
            left_panel: {
              ...
              redirect_link: {
                ...
                product_ids:
                  homePage?.content?.product_list_2?.left_panel?.redirect_link?.product_ids,
              },
            },
            products: {

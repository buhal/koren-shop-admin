...
import { IBanners, IMarketplaceThree } from '../../../../shared/interface/theme.interface';
...
export class Marketplace3 {
  ...
  home_page$: Observable<IMarketplaceThree> = inject(Store).select(ThemeState.homePage);
  ...
  public page_data: IMarketplaceThree;
  ...
  ngOnInit() {
    ...
    const home_page$ = this.store.dispatch(new GetHomePageAction({ slug: 'marketplace_three' }));
  ...
  patchForm() {
    this.home_page$.subscribe(homePage => {
      ...
      this.selectedCategories =
        homePage?.content?.categories_products.left_panel.categories.category_ids || [];
      this.selectedCategories2 =
        homePage?.content?.categories_products.right_panel.category_product.category_ids || [];
          ...
          categories_products: {
            ...
            left_panel: {
              ...
              products_list: {
                ...
                product_ids:
                  homePage?.content?.categories_products?.left_panel?.products_list?.product_ids,
              ...
              banner: {
                ...
                redirect_link: {
                  link: homePage?.content?.categories_products?.left_panel?.banner?.redirect_link
                    ?.link,
                  link_type:
                    homePage?.content?.categories_products?.left_panel?.banner?.redirect_link
                      ?.link_type,
                  product_ids:
                    homePage?.content?.categories_products?.left_panel?.banner?.redirect_link
                      ?.product_ids,
            ...
            right_panel: {
              products_list: {
                ...
                product_ids:
                  homePage?.content?.categories_products?.right_panel?.products_list?.product_ids,
                status: homePage?.content?.categories_products?.right_panel?.products_list?.status,
              },
              offer_banner: {
                banner_1: {
                  image_url:
                    homePage?.content?.categories_products?.right_panel?.offer_banner?.banner_1
                      ?.image_url,
                  status:
                    homePage?.content?.categories_products?.right_panel?.offer_banner?.banner_1
                      ?.status,
                  redirect_link: {
                    link: homePage?.content?.categories_products?.right_panel?.offer_banner
                      ?.banner_1?.redirect_link?.link,
                    link_type:
                      homePage?.content?.categories_products?.right_panel?.offer_banner?.banner_1
                ...
                banner_2: {
                  image_url:
                    homePage?.content?.categories_products?.right_panel?.offer_banner?.banner_2
                      ?.image_url,
                  status:
                    homePage?.content?.categories_products?.right_panel?.offer_banner?.banner_2
                      ?.status,
              ...
              category_product: {
                ...
                category_ids:
                  homePage?.content?.categories_products?.right_panel?.category_product
                    ?.category_ids,
                status:
                  homePage?.content?.categories_products?.right_panel?.category_product?.status,
              },
            },
          },
          featured_blogs: {
  ...
  // Merge Products Ids
  concatDynamicProductKeys(obj: IMarketplaceThree): number[] {
    const result: number[] = [];

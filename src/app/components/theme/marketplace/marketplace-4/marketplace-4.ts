...
import { IBanners, IMarketplaceFour } from '../../../../shared/interface/theme.interface';
...
export class Marketplace4 {
  ...
  home_page$: Observable<IMarketplaceFour> = inject(Store).select(ThemeState.homePage);
  ...
  public page_data: IMarketplaceFour;
  public active = 'home_banner';
  public banner = 1;
  public bannerProduct = 1;
  public sliderProducts = 1;
  public sliderProducts2 = 1;
  ...
  constructor() {
    ...
    this.form = new FormGroup({
      content: new FormGroup({
        ...
        product_banner_1: new FormGroup({
          status: new FormControl(true),
        ...
        product_banner_2: new FormGroup({
          status: new FormControl(true),
          left_panel: new FormGroup({
            product_ids: new FormControl([]),
            title: new FormControl(''),
        ...
        product_banner_3: new FormGroup({
          status: new FormControl(true),
          left_panel: new FormGroup({
            image_url: new FormControl(),
            status: new FormControl(true),
  ...
  ngOnInit() {
    ...
    const home_page$ = this.store.dispatch(new GetHomePageAction({ slug: 'marketplace_four' }));
    ...
    this.home_page$.subscribe(homePage => {
      ...
      this.form.patchValue({
        content: {
          ...
          product_banner_1: {
            status: homePage?.content?.product_banner_1?.status,
            left_panel: {
              image_url: homePage?.content?.product_banner_1?.left_panel?.image_url,
              status: homePage?.content?.product_banner_1?.left_panel?.image_url,
              redirect_link: {
                link: homePage.content?.product_banner_1?.left_panel?.redirect_link?.link,
                link_type: homePage?.content?.product_banner_1?.left_panel.redirect_link?.link_type,
                product_ids:
                  homePage?.content?.product_banner_1?.left_panel?.redirect_link?.product_ids,
              },
            },
            right_panel: {
              product_ids: homePage?.content?.product_banner_1?.right_panel?.product_ids,
              status: homePage?.content?.product_banner_1?.right_panel?.status,
            },
          },
          slider_products: {
          ...
          product_banner_2: {
            status: homePage?.content?.product_banner_2?.status,
            left_panel: {
              product_ids: homePage?.content?.product_banner_2?.left_panel?.product_ids,
              title: homePage?.content?.product_banner_2?.left_panel?.title,
              status: homePage?.content?.product_banner_2?.left_panel?.status,
            },
            center_panel: {
              banner_1: {
                image_url: homePage?.content?.product_banner_2?.center_panel.banner_1?.image_url,
                status: homePage?.content?.product_banner_2?.center_panel.banner_1?.status,
                redirect_link: {
                  link: homePage?.content?.product_banner_2?.center_panel.banner_1?.redirect_link
                    ?.link,
                  link_type:
                    homePage?.content?.product_banner_2?.center_panel.banner_1?.redirect_link
                      ?.link_type,
                  product_ids:
                    homePage?.content?.product_banner_2?.center_panel.banner_1?.redirect_link
                      ?.product_ids,
              ...
              banner_2: {
                image_url: homePage?.content?.product_banner_2?.center_panel.banner_2?.image_url,
                status: homePage?.content?.product_banner_2?.center_panel.banner_2?.status,
                redirect_link: {
                  link: homePage?.content?.product_banner_2?.center_panel.banner_2?.redirect_link
                    ?.link,
                  link_type:
                    homePage?.content?.product_banner_2?.center_panel.banner_2?.redirect_link
                      ?.link_type,
                  product_ids:
                    homePage?.content?.product_banner_2?.center_panel.banner_2?.redirect_link
                      ?.product_ids,
            ...
            right_panel: {
              product_ids: homePage?.content?.product_banner_2?.right_panel?.product_ids,
              title: homePage?.content?.product_banner_2?.right_panel?.title,
              status: homePage?.content?.product_banner_2?.right_panel?.status,
            },
          },
          product_banner_3: {
            status: homePage?.content?.product_banner_3?.status,
            left_panel: {
              image_url: homePage?.content?.product_banner_3?.left_panel?.image_url,
              status: homePage?.content?.product_banner_3?.left_panel?.status,
              redirect_link: {
                link: homePage.content?.product_banner_3?.left_panel?.redirect_link?.link,
                link_type: homePage?.content?.product_banner_3?.left_panel.redirect_link?.link_type,
                product_ids:
                  homePage?.content?.product_banner_3?.left_panel?.redirect_link?.product_ids,
              },
            },
            right_panel: {
              product_ids: homePage?.content?.product_banner_3?.right_panel?.product_ids,
              status: homePage?.content?.product_banner_3?.right_panel?.status,
            },
          },
          products_list_3: {
  ...
  // Merge Products Ids
  concatDynamicProductKeys(obj: IMarketplaceFour): number[] {
    const result: number[] = [];
